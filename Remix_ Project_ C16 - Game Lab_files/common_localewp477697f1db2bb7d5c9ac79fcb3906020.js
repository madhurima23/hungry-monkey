...
(window.locales = window.locales || {}).common_locale = {
  ...
  sendLessonShareToGoogle: function(d) { return "Share to Google Classroom"; },
  ...
  studentAnnouncementSpecial2020Body: function(d) { return "Take a Code Break with us, or see resources for students, parents, and teachers - including videos, fun tutorials, and projects!"; },
